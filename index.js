...
let calculator = {
    ...
    resetCalcMinusOp1: function () { //this resets all but operand1 and operator2, and it does not display the resets (for internal use only)
        this.operand2 = undefined;
        this.operator = undefined;
        this.result = 0;
        this.currentOperand = "";
...
// Event listening to equal sign clicked
